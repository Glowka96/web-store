...
import com.example.portfolio.webstorespring.services.authentications.JwtAuthenticationFilter;
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/v1/products/**",
                                ...
                                "/api/v1/newsletters/**",
                                "/api/v1/unsubscribe-newsletters/confirm",
                                "/api/v1/unsubscribe-product-subscriptions/**",
                                "/api/v1/login",
                                "/api/v1/logout/**",
                                "/api/v1/reset-passwords/**",
                                "/api/v1/restore-emails/confirm",
